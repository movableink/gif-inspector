...
"undefined"!=typeof document&&(n.p=(r=document.querySelectorAll("script"))[r.length-1].src.replace(/\/[^\/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("omggif",[],function(){return n(3)}))}]);(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[2],{3:function(e,t,n){"use strict"
...
case 59:c=!1
break
default:throw new Error("Unknown gif block: 0x"+e[t-1].toString(16))}function k(t,n){if(!u)return null
let r=[]
for(let i=0;i<l;i++)if(i===f)r.push({r:0,g:0,b:0,a:0})
else{const t=e[u+3*i],n=e[u+3*i+1],o=e[u+3*i+2],s=255
r.push({r:t,g:n,b:o,a:s})}return r}this.globalPalette=function(){return k()},this.framePalette=function(e){const t=this.frameInfo(e)
return k(t.palette_offset,t.palette_size)},this.numFrames=function(){return p.length},this.loopCount=function(){return m},this.frameInfo=function(e){if(e<0||e>=p.length)throw new Error("Frame index out of range.")
